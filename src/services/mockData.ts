...
export const apiEndpoints: ApiEndpoint[] = [
  {
    ...
    requestExample: 'GET /api/products?page=1&limit=20',
    responseExample: '{ "data": [{ "id": "p1", "name": "ERP License" }], "meta": { "page": 1 } }',
  },
  {
    id: 'auth-login',
    method: 'POST',
    ...
    requestExample: '{ "email": "admin@example.com", "password": "SecurePass123" }',
    responseExample: '{ "token": "...", "user": { "role": "admin" } }',
  },
  {
    id: 'update-order',
    method: 'PUT',
    ...
    requestExample: '{ "status": "shipped", "tracking": "12345" }',
    responseExample: '{ "id": "o123", "status": "shipped" }',
  },
  {
    ...
    requestExample: 'GET /api/projects/codex/case-study',
    responseExample: '{ "problem": "...", "solution": "..." }',
  },
];
